   ...
   <div class="skills-section">
      ...
      <div class="skills-grid">
         <div class="skill-category">
            ...
            <ul class="skill-list">
               <li>Swarm Robotics Systems</li>
               <li>PX4 Flight Control</li>
               <li>ROS2 Development</li>
...
Here's a sneak peek at upcoming projects and content:

.. raw:: html

   <div class="project-grid">
      <div class="project-card">
         <h3>🌳 Behavior Trees for Robotics</h3>
         <p>Advanced decision-making systems for autonomous robots using behavior tree architectures.</p>
      </div>
      
      <div class="project-card">
         <h3>🗺️ ROS2 Navigation Stack</h3>
         <p>Complete guide to implementing autonomous navigation with the latest ROS2 framework.</p>
      </div>
      
      <div class="project-card">
         <h3>🔌 Micro ROS with ESP32</h3>
         <p>Bridging microcontrollers and ROS ecosystem for distributed robotic applications.</p>
      </div>
      
      <div class="project-card">
         <h3>🕸️ ESP Mesh Network</h3>
         <p>Building robust mesh networks for IoT and robotics applications using ESP32 devices.</p>
      </div>
   </div>
...
.. toctree::
   ...
   docs/source/gazebo_terrain_generator.rst